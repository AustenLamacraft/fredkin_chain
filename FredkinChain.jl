...
"""
function find_power_spectra(N_sim::Int, size_exp::Int, time_steps::Int; init::Symbol=:dyck_init, update::Symbol=:open_update, ncores::Int=8)
    ...
    sum_over_cores = @parallel (+) for i=1:ncores
        ...
        for i in 1:ceil(Int, N_sim / ncores)
            ...
            mean_power_specs += run_sim(size_exp, time_steps, init, update)
        end
        mean_power_specs
    end
